 ...
 * 
 */
@WebServiceClient(name = "LibraryWSImplService", targetNamespace = "http://libservice/", wsdlLocation = "http://10.233.57.103:8888/ws/client?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://10.233.57.103:8888/ws/client?wsdl");
