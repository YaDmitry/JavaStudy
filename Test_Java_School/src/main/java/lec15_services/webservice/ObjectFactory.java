...
public class ObjectFactory {
    ...
    private final static QName _SayResponse_QNAME = new QName("http://client/", "sayResponse");
    private final static QName _Say_QNAME = new QName("http://client/", "say");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://client/", name = "sayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://client/", name = "say")
